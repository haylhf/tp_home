...
//添加中心圆
    ...
    function drawPercentNumber() {
        var percentNumber = new Konva.Text({
            ...
            fillLinearGradientStartPoint: {x: 0.5, y: 0},
            fillLinearGradientEndPoint: {x: 0.5, y: 1},
    ...
    function addDispartToUI(angle, item, id) {
        ...
        var signedUser = new Konva.Text({
            ...
            // fillLinearGradientColorStops: [0.5, 'red', 0.5, 'white'],
            // fillLinearGradientStartPoint: {x: 0, y: 2},
        });
